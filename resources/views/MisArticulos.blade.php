                ...
                <div class="flex flex-col">
                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                            ...
                            <a href="{{route('articles.create')}}" class=" mr-2  bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"">
                                <i class="fa-solid fa-plus">Nuevo Articulo</i>           
                            </a>
                        </div>
                    </div>
                </div>
